...
namespace eval {
  ...
  namespace {
    ...
    int PASSED_MG[8] = {0, 0, -42, 0, 31, 50, 154, 0}; // tunable [1..6]
    int PASSED_EG[8] = {0, -1, 41, 21, 27, 4, -36, 0}; // tunable [1..6]
    ...
    int           OPEN_FILE_PENALTY = 27; // tunable
    ...
    int MOB_MG[NPIECE_TYPES] = {0, 7, 5, 4, 3, 0}; // P N B R Q K; tunable [N..Q]
    int MOB_EG[NPIECE_TYPES] = {0, 6, 2, 3, 4, 0}; // tunable [N..Q]
    ...
    int BISHOP_PAIR_EG = 46; // tunable
    int ROOK_OPEN      = 9; // file with no pawns at all; tunable
    int ROOK_SEMIOPEN  = -2; // file with no friendly pawns; tunable
    int ROOK_7TH_MG    = -51; // tunable
    int ROOK_7TH_EG    = 22; // tunable
    ...
    Score THREAT_BY_PAWN                = {28, 28}; // a pawn attacks any enemy minor/rook/queen; tunable
    Score THREAT_BY_MINOR[NPIECE_TYPES] = {{0, 0},   {18, 28},  {26, 19},
                                           {34, -4}, {44, -45}, {0, 0}}; // victim: P N B R Q K; tunable [N..Q]
    Score THREAT_BY_ROOK[NPIECE_TYPES]  = {{0, 0},      {15, 8}, {20, 12},
                                           {-419, 582}, {63, 6}, {0, 0}}; // rooks chiefly threaten R/Q; tunable [N..Q]
    ...
    int           KING_ATT_UNIT                 = 6; // scales the quadratic king-danger score; tunable
