...
namespace eval {
  ...
  namespace {
    ...
    int ISOLATED_PENALTY = 15; // tunable
    ...
    int PASSED_MG[8] = {0, 5, 10, 15, 25, 40, 60, 0}; // tunable [1..6]
    int PASSED_EG[8] = {0, 15, 25, 40, 65, 100, 150, 0}; // tunable [1..6]
    ...
    int PASSED_KDIST_W[8] = {0, 0, 0, 1, 2, 3, 5, 0}; // by rank of advancement; tunable [3..6]
    ...
    int MOB_MG[NPIECE_TYPES] = {0, 4, 3, 2, 1, 0}; // P N B R Q K; tunable [N..Q]
    int MOB_EG[NPIECE_TYPES] = {0, 4, 5, 4, 2, 0}; // tunable [N..Q]
    ...
    int BISHOP_PAIR_MG = 25; // tunable
    int BISHOP_PAIR_EG = 45; // tunable
    int ROOK_OPEN      = 25; // file with no pawns at all; tunable
    int ROOK_SEMIOPEN  = 12; // file with no friendly pawns; tunable
    int ROOK_7TH_MG    = 15; // tunable
    ...
    Score THREAT_BY_PAWN                = {80, 55}; // a pawn attacks any enemy minor/rook/queen; tunable
    Score THREAT_BY_MINOR[NPIECE_TYPES] = {{0, 0},   {22, 35}, {24, 35},
                                           {45, 50}, {48, 55}, {0, 0}}; // victim: P N B R Q K; tunable [N..Q]
    Score THREAT_BY_ROOK[NPIECE_TYPES]  = {{0, 0},  {20, 40}, {22, 40},
                                           {0, 20}, {40, 40}, {0, 0}}; // rooks chiefly threaten R/Q; tunable [N..Q]
    Score HANGING                       = {28, 22}; // per undefended enemy piece we attack; tunable
    ...
    int           KING_ATT_WEIGHT[NPIECE_TYPES] = {0, 2, 2, 3, 5, 0}; // P N B R Q K (per zone square); tunable [N..Q]
